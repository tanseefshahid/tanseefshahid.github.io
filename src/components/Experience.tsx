            ...
            >
                ...
                <div className="border-l-2 border-white/10 pl-8 space-y-12">
                    <div className="relative">
                        ...
                        <h3 className="text-xl font-bold">Research Engineer</h3>
                        <p className="text-cyan-400 mb-2">HyVision System • 2021 - Present</p>
                        <p className="text-gray-400">
                            Leading research and development in computer vision and 3D reconstruction technologies.
                            Specializing in virtual fitting systems, 3D avatar generation, and real-time object detection for industrial safety.
                        </p>
                    </div>
